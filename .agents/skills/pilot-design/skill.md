...
cat .Codex/pilot/component-registry.json 2>/dev/null || echo "No component registry"
```
...
Create/update `.Codex/pilot/component-registry.json`:
...
4. **Component Registry**: `.Codex/pilot/component-registry.json` exists and is accurate
...
--------------------------------------------------------------------
  ...
  - .Codex/pilot/component-registry.json (registry)
