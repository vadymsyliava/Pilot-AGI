...
│                                                                 │
│  Schema: .Codex/pilot/schemas/subtask.yaml                     │
│  Output: .Codex/pilot/schemas/subtask-output.yaml              │
└────────────────────────────┬────────────────────────────────────┘
                             │
                             ▼
┌─────────────────────────────────────────────────────────────────┐
...
For each atomic action, create a contract following `.Codex/pilot/schemas/subtask.yaml`:
...
```bash
cat .Codex/pilot/agent-registry.json 2>/dev/null
```
...
## Your Rules
{Load from .Codex/pilot/rules/frontend.yaml}
...
## Your Rules
{Load from .Codex/pilot/rules/backend.yaml}
...
## Your Rules
{Load from .Codex/pilot/rules/security.yaml}
